...
namespace ClusterDesignTool
{
	...
	public class node
	{
        ...
        {
            return getNumberOfCores() / getNodeMemory();
        }
		...
		public string toString()
		{
			return 	Environment.NewLine +
                    numOfCPUS + " X CPU'S: " + cpuUsed.toString() + Environment.NewLine + Environment.NewLine +
                    numOfMems + " X DIMM'S " + memUsed.toString() + Environment.NewLine + Environment.NewLine +
                    numOfGPUS + " X GPU's " + gpuUsed.toString();
		}
	}
}
