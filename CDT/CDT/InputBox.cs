...
namespace CDT
{
    public static class InputBox
    {
        ...
        private static PictureBox Picture(Icon icon)
        {
            ...
            {
                case Icon.Error:
                    stream = assembly.GetManifestResourceStream(@"error.png");
                    break;
                case Icon.Exclamation:
                    stream = assembly.GetManifestResourceStream(@"CDT.exclamation.png");
                    break;
                case Icon.Information:
                    stream = assembly.GetManifestResourceStream(@"CDT.information.png");
                    break;
                case Icon.Question:
                    stream = assembly.GetManifestResourceStream(@"question.png");
                    break;
                case Icon.Nothing:
                    stream = assembly.GetManifestResourceStream(@"CDT.nic80x80.png");
                    break;
            }
            if(stream != null)
